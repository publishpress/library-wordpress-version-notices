...
class VersionsCest
{
    public function testAllVersionsAreRegistered(WpunitTester $I)
    {
        ...
        $I->assertEquals([
            ...
            '2.0.2' => 'PublishPress\WordpressVersionNotices\initialize2Dot0Dot2',
        ], $registeredVersions);
    }
    ...
    public function testLatestVersionIsTheCurrentVersion(WpunitTester $I)
    {
        ...
        $I->assertEquals('2.0.2', $latestVersion);
    }
    ...
    public function testLatestVersionCallbackIsTheLastOne(WpunitTester $I)
    {
        ...
        $I->assertEquals('PublishPress\WordpressVersionNotices\initialize2Dot0Dot2', $latestVersionCallback);
    }
